...
REM **************************************
REM DNSサービスインスタンス インスタンス情報取得テストバッチ
REM 
...
call %CURL_CMD% -X GET localhost:8080/admin/api/dns/service/get/dns-service-instance -u %LOGIN_USER_NAME%:%LOGIN_PASSWORD%  -G -d UserName=%TARGET_USER% -d DNSServiceInstanceName=%SERVICE_INSTANCE%
