...
@ComponentScan
public class UDPResolverImpl extends SimpleUDPResolverImpl implements IDNSLookupClient
{

    public UDPResolverImpl() throws DNSServiceCommonException
    {
        super();
    }
    ...
    @Autowired
    @Qualifier("dnsMessageTransporterImpl")
